local NeP_Selected = false

local NeP_Specs = {71,72,73,65,66,70,253,254,255,259,260,261,256,257,258,250,251,252,262,263,264,62,63,64,265,266,267,268,269,270,102,103,104,105,577,581}
print('jkbdskfbjksdbfjksbdkjlfbkjsdbfjkbjk')
-- register the cr for all specs
if NeP then
	for i=1, #NeP_Specs do
		print(i)
		local SpecID = NeP_Specs[i]
		NeP.CR:Add(SpecID, {
		  name = 'Ovale '..SpecID,
		  load = function()
					NeP_Selected = true
					print('test',NeP_Selected)
		  end,
		  unload = function()
					NeP_Selected = false
					print(NeP_Selected)
